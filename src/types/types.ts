...
export interface AppQuery {
  users: <T = Array<User | null>>(parent: undefined, args: { query: string, first?: number, skip?: number, after?: string } | null, context: Context, info?: GraphQLResolveInfo | string) => Promise<T>,
  posts: <T = Array<Post | null>>(parent: undefined, args: { query: string, first?: number, skip?: number, after?: string } | null, context: Context, info?: GraphQLResolveInfo | string) => Promise<T>,
  comments: <T = Array<Comment | null>>(parent: undefined, args: { query: string, first?: number, skip?: number, after?: string } | null, context: Context, info?: GraphQLResolveInfo | string) => Promise<T>,
